...
def mle(chain_results):
    ...
    return tools.normalize(chain_results['sample'][index]), chain_results['log_prob_trace'][index]
...
def mean_phc(chain_results):
    ...
    normalized_results = tf.map_fn(
        tools.normalize, chain_results['sample'])
...
def hmc(n_iter, burn_frac, initial_grid, demo, observed, expec_scoring=False, init_step_size=0.03, adaptation_frac=0.6, pause_point=10):
    ...
    return: a dict of the chain, the scorer and the traces
    """
